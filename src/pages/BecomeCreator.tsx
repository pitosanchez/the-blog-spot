...
const benefits = [
  {
    ...
    description:
      "Keep 90% of everything you earn. No hidden fees, no surprises.",
    icon: DollarIcon,
  },
  {
    title: "Your Content, Your Rules",
    description:
      "Set your own prices, create your own schedule, build your own brand.",
    icon: ShieldIcon,
  },
  {
    title: "Built-in Audience",
    description:
      "Access our growing community of readers hungry for quality content.",
    icon: UsersIcon,
  },
  {
    title: "Professional Tools",
    description:
      "Analytics, scheduling, and content management tools at your fingertips.",
    icon: ToolsIcon,
  },
];
...
export default function BecomeCreator() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : "Failed to create creator profile"
      );
    } finally {
      setIsLoading(false);
    }
    ...
    <div className="min-h-screen bg-ink-black">
        ...
        <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:flex-shrink-0 lg:pt-8">
            ...
            <p className="mt-6 text-lg leading-8 text-warm-gray">
              ...
              Share your expertise, build your audience, and keep 90% of
              everything you earn.
            </p>
            <div className="mt-10 flex items-center gap-x-6">
              <a
                href="#apply"
                className="rounded-md bg-electric-sage px-3.5 py-2.5 text-sm font-semibold text-ink-black shadow-sm hover:bg-electric-sage/90 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-electric-sage"
              >
                Start Creating
              </a>
              <a
                href="/creators"
                className="text-sm font-semibold leading-6 text-electric-sage"
              >
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-24 sm:py-32">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-base font-semibold leading-7 text-electric-sage">
            Benefits
          </h2>
            ...
            {benefits.map((benefit) => (
              <div key={benefit.title} className="flex flex-col">
                <dt className="flex items-center gap-x-3 text-base font-semibold leading-7 text-white">
                  <benefit.icon
                    className="h-5 w-5 flex-none text-electric-sage"
                    aria-hidden="true"
                  />
                  {benefit.title}
                </dt>
